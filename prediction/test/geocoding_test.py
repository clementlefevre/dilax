...
def test_get_region():
    ...
    sites = [Site(idbldsite=12, site_name='Stuttgart', latitude=48.776630499999996,
             ...
             Site(idbldsite=4, site_name='Muenchen Herren',
                  latitude=48.142641, longitude=11.576903, region='Bayern'),
             Site(idbldsite=5, site_name='Duesseldorf Herren', latitude=51.224403,
                  longitude=6.774597999999999, region='Nordrhein-Westfalen'),
             Site(idbldsite=6, site_name='Duesseldorf Damen', latitude=51.224403,
                  longitude=6.774597999999999, region='Nordrhein-Westfalen'),
             Site(idbldsite=7, site_name='Wiesbaden', latitude=50.081434,
                  longitude=8.244644000000001, region='Hessen'),
             Site(idbldsite=8, site_name='Bikini Berlin', latitude=52.50548199999999,
             ...
             Site(idbldsite=10, site_name='Nuernberg', latitude=49.452290999999995,
